...
public final class delete_005fdates_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String psw = "";
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <center>\n");
      out.write("            <form action=\"delete_dates.jsp\">\n");
      out.write("            \n");
      out.write("                    \n");
      out.write("            <h2 style=\"display:inline-block\"> Enter the date  <input type=\"text\" name=\"date\"/></h2>\n");
      out.write("            \n");
      out.write("            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
      out.write("            \n");
...
//String personID = Integer.parseInt(id);
try
{
Class.forName(driverName);
con = DriverManager.getConnection(url,user,psw);
//String sql2 = "select * from package where p_id="+personID;
String sql = "DELETE FROM date_availability WHERE date = " + "'"+id+"'";
...
out.println(sqe);
      ...
      out.write("<br>\n");
      out.write("<center>  <a href=\"after_admin_manipulation_delete.jsp\"><button  class=\"btn btn-primary btn-lg\"> Back</button></a> </center>\n");
      out.write("</body>\n");
      out.write("</html>");
    } catch (Throwable t) {
